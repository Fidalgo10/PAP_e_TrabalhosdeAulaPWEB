...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('scroll', function () {
    ...
    if (scrollTop > lastScrollTop) {
      ...
      voltarInicioBtn.style.backgroundColor = 'darkblue'; // Cor de fundo quando fixo
      voltarInicioBtn.style.color = 'white'; // Cor do texto quando fixo
    } else {
      // Scrolling up
      voltarInicioBtn.classList.remove('fixed-top-left');
      headerElement.style.top = '0'; // Mostrar o cabeçalho
      voltarInicioBtn.style.backgroundColor = 'white'; // Cor de fundo no cabeçalho
      voltarInicioBtn.style.color = 'darkblue'; // Cor do texto no cabeçalho
    }
